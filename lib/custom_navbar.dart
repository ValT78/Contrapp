...
class CustomNavbarState extends State<CustomNavbar>
  ...
  void initState() {
    ...
    _color = ColorTween(begin: Colors.blue[100], end: Colors.blue[100])
        .animate(_controller);
  }
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              return Transform.scale(
                                scale: _scale.value,
                                child: Container(
                                  height: max(100 * widthFactor,
                                      100), // Ajustez la hauteur comme vous le souhaitez
                                  width:
                                      100, // Ajustez la largeur comme vous le souhaitez
                                  color: _color
                                      .value, // Ajoutez votre couleur de fond ici
                                  child: Padding(
                                  ...
                                  backgroundColor:
                                    ...
                                    (Set<WidgetState> states) {
                                      if (states
                                        ...
                                        return Colors.green
                                            .shade900; // Couleur lorsqu'on clique sur le bouton
                                      } else if (states
                                          .contains(WidgetState.hovered)) {
                                        return Colors.green
                                            .shade700; // Couleur lorsqu'on passe dessus
                                      }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text('Sauvegarder et recommencer',
                          style: TextStyle(
                              fontSize: 50 * widthScreen / 1920,
                              color: Colors.black,
                              fontWeight: FontWeight.bold)),
