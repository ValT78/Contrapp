              ...
              Stack(
                children: [
                  ...
                  MainSearchBar(
                    ...
                    yPosition: 150,
                    storeList:
                        equipToPick.equipList.map((e) => e.equipName).toList(),
                    addElement: (String equipName) {
                      if (equipPicked.equipList
                          .any((element) => element.equipName == equipName)) {
                        Equipment existingEquip = equipPicked.equipList
                            .firstWhere(
                                (element) => element.equipName == equipName);
                        equipPicked.addMachine(existingEquip, Machine());
                      } else {
                        Equipment newEquip = equipToPick.equipList
                            .firstWhere(
                                (element) => element.equipName == equipName)
                            .clone();
                    ...
                    createNewElement: (String equipName) {
                      equipToPick.addEquipment(
                          Equipment.oneValue(equipName: equipName));
